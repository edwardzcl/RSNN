...
class ASRCNN(object):
    def __init__(self, input_x, input_y, config, width, height, num_classes, is_train=True, reuse=False):  # 20,80
        ...
        with tf.variable_scope("binarynet", reuse=reuse):
            ...
            shortcut0 = tl.layers.Quant_Conv2d(net0, 32, (2, 2), (2, 2), padding='SAME', b_init=None, name='shortcut0')
            #net = tl.layers.MaxPool2d(net, (2, 2), (2, 2), padding='SAME', name='pool1')
            #shortcut0 = tl.layers.BatchNormLayer(shortcut0, act=tf.nn.relu, is_train=is_train, name='bn_shortcut0')

            net2 = tl.layers.Quant_Conv2d(net1, 32, (2, 2), (2, 2), padding='VALID', b_init=None, name='bcnn2')
            ...
            net3= tl.layers.Quant_Conv2d(shortcut0, 32, (3, 3), (1, 1), padding='VALID', b_init=None, name='bcnn3')
